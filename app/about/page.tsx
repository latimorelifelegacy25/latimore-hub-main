        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem' }} className="creds-grid">
            {[
              ...
              { icon: <GraduationCap size={32} color={navy} />, title: 'MBA & Graduate Leadership Education', body: 'Master of Business Administration (2026) — American InterContinental University. Also holds an MS in Management & Leadership with Public Administration concentration from East Stroudsburg University.' },
      ...
      <section style={{ background: 'linear-gradient(135deg, #C9A24D 0%, #E5C882 100%)', padding: '4rem 0', textAlign: 'center' }}>
        <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 20px' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href={BRAND.bookingUrl} target="_blank" rel="noopener noreferrer" style={{ background: '#0E1A2B', color: '#fff', padding: '1rem 2rem', borderRadius: 5, fontWeight: 700, textDecoration: 'none', fontSize: '1rem' }}>
              Book Free Consultation
            </a>
            <a href={`tel:${BRAND.phoneRaw}`} style={{ background: 'transparent', color: '#0E1A2B', border: '2px solid #0E1A2B', padding: '1rem 2rem', borderRadius: 5, fontWeight: 700, textDecoration: 'none', fontSize: '1rem' }}>
              Call {BRAND.phone}
            </a>
          </div>
        </div>
