  ...
  return (
    <main>
      ...
      <section className="cta-strip reveal">
        ...
        <div className="cta-buttons"><a href="https://latimorelifelegacy.fillout.com/latimorelifelegacy" className="btn-primary" target="_blank" rel="noopener"><i className="fas fa-clipboard-list" />Start My Free Review</a><a href="tel:+17176152613" className="btn-secondary"><i className="fas fa-phone" />Call Jackson Direct</a></div>
      </section>
      ...
      <div className={`sticky-cta ${showSticky ? 'show' : ''}`}><div className="sticky-cta-text"><span>Free</span> Protection Review</div><a href="https://latimorelifelegacy.fillout.com/latimorelifelegacy" className="sticky-btn" target="_blank" rel="noopener">Start Now</a></div>
    </main>
  );
}
