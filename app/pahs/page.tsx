    ...
    <main>
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="beat-img-wrap"><Image src="/pahs-latimore-logo.png" alt="#TheBeatGoesOn — Latimore Life & Legacy" width={340} height={200} style={{ width: '100%', height: 'auto' }} /></div>
      ...
      <section className="cta-strip reveal">
        ...
        <div className="cta-buttons"><a href="https://latimorelifelegacy.fillout.com/pahs" className="btn-primary" target="_blank" rel="noopener"><i className="fas fa-clipboard-list" />Start My Free Review</a><a href="tel:+17176152613" className="btn-secondary"><i className="fas fa-phone" />Call Jackson Direct</a></div>
      </section>
      ...
      <section className="intake-section" id="intakeFormSection">
        <div className="intake-inner reveal">
          ...
          <div className="intake-box">
            ...
            <a href="https://latimorelifelegacy.fillout.com/pahs" className="intake-external-link" target="_blank" rel="noopener">Prefer our detailed intake questionnaire? Click here.</a>
          </div>
        </div>
      </section>
      ...
      <div className={`sticky-cta ${showSticky ? 'show' : ''}`}><div className="sticky-cta-text"><span>Free</span> Protection Review</div><a href="https://latimorelifelegacy.fillout.com/pahs" className="sticky-btn" target="_blank" rel="noopener">Start Now</a></div>
    </main>
  );
}
