  ...
  return (
    <main>
      ...
      <section className="cta-strip reveal">
        ...
        <div className="cta-buttons"><a href="#intakeFormSection" className="btn-primary"><i className="fas fa-clipboard-list" />Start My Free Review</a><a href="tel:+18568951457" className="btn-secondary"><i className="fas fa-phone" />Call Jackson Direct</a></div>
      </section>
