      ...
      <div className="blog-root">
        ...
        <header style={{ background: C.navyDeep, borderBottom: `2px solid ${C.gold}`, padding: '0 2rem', position: 'sticky', top: 0, zIndex: 100 }}>
          <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64, gap: '2rem' }}>
            ...
            <a href="tel:5709001977" style={{ background: C.gold, color: C.navyDeep, fontFamily: "'DM Mono',monospace", fontSize: 11, letterSpacing: '0.08em', textTransform: 'uppercase', fontWeight: 500, padding: '8px 16px', borderRadius: 2, textDecoration: 'none', whiteSpace: 'nowrap' }}>(570) 900-1977</a>
          </div>
        </header>
        ...
        <div style={{ background: C.goldPale, border: `1px solid ${C.goldBorder}`, borderRadius: 3, padding: '3rem', maxWidth: 1200, margin: '0 auto 3rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="tel:5709001977" style={{ background: C.navy, color: C.white, fontFamily: "'DM Mono',monospace", fontSize: 12, letterSpacing: '0.1em', textTransform: 'uppercase', padding: '14px 28px', borderRadius: 2, textDecoration: 'none' }}>(570) 900-1977 — Call Now</a>
        ...
        <footer style={{ background: C.navyDeep, borderTop: `2px solid ${C.gold}`, padding: '2rem', textAlign: 'center' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '1rem' }}>
              {([['/', 'Home'], ['/blog', 'Blog'], ['tel:5709001977', '(570) 900-1977'], ['mailto:jackson1989@latimorelegacy.com', 'Email']] as [string, string][]).map(([href, label]) => (
