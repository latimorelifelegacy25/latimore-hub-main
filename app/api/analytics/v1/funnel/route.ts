...
import { getAnalyticsFunnel, getDataQualityWarnings } from '@/lib/analytics/queries'
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    logger.error({ err }, 'analytics/v1/funnel error')
    return NextResponse.json({ ok: false, error: 'Failed to load funnel data.' }, { status: 500 })
  }
}
