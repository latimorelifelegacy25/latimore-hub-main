...
const BUSINESS_KNOWLEDGE: Record<string, string> = {
  general:
    'Latimore Life & Legacy LLC | PA DOI #1268820 | NIPR #21638507 | Territory: Schuylkill, Luzerne, Northumberland Counties, PA | GFI Affiliation | Founder: Jackson M. Latimore Sr. | Phone: 570-900-1799.',
