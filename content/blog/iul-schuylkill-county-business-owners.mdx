...
For self-employed business owners, protecting liquid capital is critical. Unlike traditional stock portfolios that can drop 20% to 30% during economic downturns, an IUL contains a contractual **0% downside floor guarantee** on index-linked crediting. When the market index rises, your cash value earns interest up to an annual cap; when the market crashes, **your index credit for that period is 0% rather than negative**. The floor protects against market losses — it does not offset mortality charges, administrative fees, or rider costs, which continue to be deducted from the policy and can reduce cash value or cause a lapse if the policy is underfunded.
...
<ComparisonTable
  ...
  rows={[
    ["Protection Against Market Loss", "Yes (low interest yields)", "No (100% exposed to market drops)", "Yes (0% floor on index credits; policy charges still apply)"],
