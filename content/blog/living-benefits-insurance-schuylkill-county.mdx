...
image: "/article-images/editorial-2-11.jpg"
imageAlt: "Editorial photograph for living benefits insurance schuylkill county"
---
...
County health measures vary by year and metric. Review current [Pennsylvania Department of Health county profiles](https://www.health.pa.gov/topics/HealthStatistics/VitalStatistics/CountyHealthProfiles/Pages/default.aspx) for local comparisons. Health conditions can create unexpected costs and lost income. Furthermore, local families operate on tighter margins, with a median household income hovering around $68,300—roughly 12.4% lower than the state average.
